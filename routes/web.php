...
Route::get('/blog/details/{id}', [IndexController::class, 'BlogDetails'])->name('blog.details');
Route::get('/category/blog/{id}', [IndexController::class, 'CategoryBlog'])->name('category.blog');
...
Route::get('/store/message', [IndexController::class, 'StoreMesseage'])->name('store.message');
