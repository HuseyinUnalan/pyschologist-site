        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="{{ route('dashboard') }}" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="{{ asset($settings->logo) }}" alt="logo-sm" height="60">
                    </span>
                    <span class="logo-lg">
                        <img src="{{ asset($settings->logo) }}" alt="logo-dark" height="60">
                    </span>
                </a>

                <a href="{{ route('dashboard') }}" class="logo logo-light">
                    <span class="logo-sm">
                        <img src="{{ asset($settings->logo) }}" alt="logo-sm-light" height="60">
                    </span>
                    <span class="logo-lg">
